...
namespace MiPagoManager.Models
{
    ...
    public class RegisterAdminViewModel:RegisterViewModel
    {
        ...
        public IEnumerable<System.Web.Mvc.SelectListItem> RolesList => db_manager.Roles.Select(r => new System.Web.Mvc.SelectListItem { Selected = true, Text = r.Name, Value = r.Name });
    }
}
